...
(async function NabdaApp() {
  ...
  function startDataListeners() {
    ...
    // Note: Firebase rules filter groups to only accessible ones
  ...
  function renderNewGroup(){
    ...
    const doCreate=async()=>{const res=await Groups.create(S.me,inp.value);if(res.error)UI.toast(res.error,'error');else{UI.toast('تم إنشاء المجموعة ✓','success');S.tab='groups';go('home');}};
